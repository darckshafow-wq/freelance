...
<head>
    ...
    <title>Mes Projets - FreelanceFlow</title>
...
<main class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="card" style="text-align:left; color:var(--text-light);">
            <p>🚧 Cette page est en cours de construction.</p>
            <p>Vous pourrez voir ici la liste complète de vos missions et projets.</p>
        </div>
