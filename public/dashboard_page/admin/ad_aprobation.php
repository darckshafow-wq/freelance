...
<head>
    ...
    <title>Approbations - Admin FreelanceFlow</title>
    ...
    <div class="content-wrapper">
        <div class="section-header">
            <div class="content-title-area">
                <h1>Approbations</h1>
                <p>Révision et validation des nouvelles missions avant publication.</p>
            </div>
        </div>
        ...
        <section class="table-card">
                        ...
                        <tbody>
                            <?php foreach ($tasks as $task): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span style="padding:2px 8px; border-radius:4px; background:#ffedd5; color:#c2410c; font-size:0.85rem; font-weight:600;">
                                            <?= htmlspecialchars($task['status']) ?>
                                        </span>
                                    </td>
                                    <td>
                                        <a href="index.php?page=validate_task&id=<?= $task['id'] ?>" class="action-btn btn-validate">✅ Valider</a>
                                        <a href="index.php?page=publish_task&id=<?= $task['id'] ?>" class="action-btn btn-edit" style="background:#e0f2fe; color:#0284c7;">📢 Publier</a>
            ...
            <?php else: ?>
                <div style="padding:2rem; text-align:center; color:#94a3b8;">Aucune approbation en attente. Bon travail !</div>
            <?php endif; ?>
        </section>
